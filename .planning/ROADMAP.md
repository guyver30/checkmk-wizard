...
- [x] 13-04-PLAN.md — Poller carries map_position/unmanaged in the topology payload (PLR-13) + scoped topology_editor credential provisioning script
- [x] 13-05-PLAN.md — Browser Checkmk REST writer (GET-ETag-merge-PUT, serialized, batched activation), scoped-credential config, same-origin /checkmk-api proxy
...
- [x] 14-04-PLAN.md — Incident card list above the stats strip, live wiring of dimming, `/?incident=` highlight (DASH-14, DASH-15)
